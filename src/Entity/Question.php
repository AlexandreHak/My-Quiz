 ...
 * Question
 *
 * @ORM\Table(name="question", indexes={@ORM\Index(name="IDX_B6F7494E12469DE2", columns={"category_id"})})
 * @ORM\Entity
 */
class Question
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\History", mappedBy="question")
     */
    private $histories;
